...
class Koch(
    ...
    override fun decode(textSize:Int) {
        ...
        for (i in  text.indices) {
            ...
            if (abs(block[positiveVal1].toPolar().getModule()) - abs(
                    block[positiveVal2].toPolar().getModule()
                ) > EPS - 0.4
            ) {
    ...
    private fun correctFirstValue(value1: Complex, value2: Complex, eps: Double): Complex {
        ...
        return Complex(
            value1.getModule() * cos(value1.getArgument()) + i * eps,
            value1.getModule() * sin(value1.getArgument())
        )
    }
    ...
    private fun correctSecondValue(value1: Complex, value2: Complex, eps: Double): Complex {
        ...
        return Complex(
            value2.getModule() * cos(value2.getArgument()) + i * eps,
            value2.getModule() * sin(value2.getArgument())
        )
    }
